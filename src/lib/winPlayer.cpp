...
void Player::Play(){
	if(this->activePlayer.has_value() && this->players.find(this->activePlayer.value()) != this->players.end()) FireAndForget(this->players[this->activePlayer.value()]->TryPlayAsync());
};

void Player::Pause(){
	if(this->activePlayer.has_value() && this->players.find(this->activePlayer.value()) != this->players.end()) FireAndForget(this->players[this->activePlayer.value()]->TryPauseAsync());
}

void Player::PlayPause(){
	if(this->activePlayer.has_value() && this->players.find(this->activePlayer.value()) != this->players.end()) FireAndForget(this->players[this->activePlayer.value()]->TryTogglePlayPauseAsync());
}

void Player::Stop(){
	if(this->activePlayer.has_value() && this->players.find(this->activePlayer.value()) != this->players.end()) FireAndForget(this->players[this->activePlayer.value()]->TryStopAsync());
}

void Player::Next(){
	if(this->activePlayer.has_value() && this->players.find(this->activePlayer.value()) != this->players.end()) FireAndForget(this->players[this->activePlayer.value()]->TrySkipNextAsync());
}

void Player::Previous(){
	if(this->activePlayer.has_value() && this->players.find(this->activePlayer.value()) != this->players.end()) FireAndForget(this->players[this->activePlayer.value()]->TrySkipPreviousAsync());
}
